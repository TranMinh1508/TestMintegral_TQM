if ( TRACE ) { TRACE( JSON.parse( '["DeviceOrientation#Update","Hand#Start","Hand#SetUp","Hand#Click","VideoManager#Start","VideoManager#Update","VideoManager#OnHorizontal","VideoManager#OnVertical","VideoManager#TriggerCTA"]' ) ); }
/**
 * @version 1.0.9151.18728
 * @copyright anton
