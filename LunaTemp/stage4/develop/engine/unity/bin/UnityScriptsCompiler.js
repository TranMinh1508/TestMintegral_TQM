...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
    ...
    Bridge.define("DeviceOrientation", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "DeviceOrientation#init", this ); }
        ...
        methods: {
            ...
            Start: function () {
if ( TRACE ) { TRACE( "DeviceOrientation#Start", this ); }
            ...
            /*DeviceOrientation.Start end.*/

            /*DeviceOrientation.CheckOrientation start.*/
            CheckOrientation: function () {
if ( TRACE ) { TRACE( "DeviceOrientation#CheckOrientation", this ); }
            ...
            /*DeviceOrientation.CheckOrientation end.*/
...
if ( TRACE ) { TRACE( "Hand#Start", this ); }
                ...
                this.StartCoroutine$1(this.Loop());
            },
            /*Hand.Start end.*/

            /*Hand.Loop start.*/
            Loop: function () {
if ( TRACE ) { TRACE( "Hand#Loop", this ); }
...
if ( TRACE ) { TRACE( "Hand#Click", this ); }
    ...
    Bridge.define("VideoConverter", {
        ...
        methods: {
            /*VideoConverter.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "VideoConverter#Start", this ); }

                var base64String = this.EncodeVideoToBase64(this.videoPathOriginal);
                var videoPath = this.DecodeBase64ToVideo(base64String);
                if (videoPath != null) {
                    this.PlayVideo(videoPath);
                }
                this.StartCoroutine$1(this.LoadVideo());
            },
            /*VideoConverter.Start end.*/

            /*VideoConverter.LoadVideo start.*/
            LoadVideo: function () {
if ( TRACE ) { TRACE( "VideoConverter#LoadVideo", this ); }
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    videoPath = System.IO.Path.Combine(UnityEngine.Application.streamingAssetsPath, this.name$1);


                                        request = UnityEngine.Networking.UnityWebRequest.Get(videoPath);
                                    $step = 1;
                                    continue;
                                }
                                case 1: {
                                ...
                                case 2: {
                                    if (request.result !== UnityEngine.Networking.UnityWebRequest.Result.Success) {
                                            UnityEngine.Debug.LogError$2("L\u1ed7i t\u1ea3i video: " + (request.error || ""));
                                        } else {
                                            url = videoPath;
            ...
            /*VideoConverter.LoadVideo end.*/

            /*VideoConverter.EncodeVideoToBase64 start.*/
            EncodeVideoToBase64: function (path) {
if ( TRACE ) { TRACE( "VideoConverter#EncodeVideoToBase64", this ); }

                if (!System.IO.File.Exists(path)) {
                    UnityEngine.Debug.LogError$2("File kh\u00f4ng t\u1ed3n t\u1ea1i: " + (path || ""));
                    return null;
                }

                var videoBytes = System.IO.File.ReadAllBytes(path);
                var base64String = System.Convert.toBase64String(videoBytes, null, null, null);
                return base64String;
            },
            /*VideoConverter.EncodeVideoToBase64 end.*/

            /*VideoConverter.DecodeBase64ToVideo start.*/
            DecodeBase64ToVideo: function (base64) {
if ( TRACE ) { TRACE( "VideoConverter#DecodeBase64ToVideo", this ); }

                if (System.String.isNullOrEmpty(base64)) {
                    UnityEngine.Debug.LogError$2("Chu\u1ed7i Base64 r\u1ed7ng ho\u1eb7c null!");
                    return null;
                }

                var videoBytes = System.Convert.fromBase64String(base64);
                var tempPath = System.IO.Path.Combine("", "decodedVideo_" + this.gameObject.GetInstanceID() + ".mp4");

                System.IO.File.WriteAllBytes(tempPath, videoBytes);
                UnityEngine.Debug.Log$1("\u0110\u00e3 l\u01b0u video t\u1ea1i: " + (tempPath || ""));

                return tempPath;
            },
            /*VideoConverter.DecodeBase64ToVideo end.*/

            /*VideoConverter.PlayVideo start.*/
            PlayVideo: function (path) {
if ( TRACE ) { TRACE( "VideoConverter#PlayVideo", this ); }

                this.videoPlayer.url = "file://" + (path || "");
                this.videoPlayer.Play();
            },
            /*VideoConverter.PlayVideo end.*/
    ...
    Bridge.define("VideoManager", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "VideoManager#init", this ); }
        ...
        methods: {
            /*VideoManager.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "VideoManager#Awake", this ); }
            ...
            /*VideoManager.Awake end.*/

            /*VideoManager.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "VideoManager#Update", this ); }

                if (UnityEngine.Input.GetMouseButtonDown(0)) {
                    this.TriggerCTA();
                }
            },
            /*VideoManager.Update end.*/

            /*VideoManager.OnHorizontal start.*/
            OnHorizontal: function () {
if ( TRACE ) { TRACE( "VideoManager#OnHorizontal", this ); }

                this.canvasHorizon.sortingOrder = this.highCanvas;
                this.canvasVertical.sortingOrder = this.lowCanvas;
...
if ( TRACE ) { TRACE( "VideoManager#OnVertical", this ); }
                ...
                this.canvasHorizon.sortingOrder = this.lowCanvas;
                this.canvasVertical.sortingOrder = this.highCanvas;

            },
            /*VideoManager.OnVertical end.*/

            /*VideoManager.TriggerCTA start.*/
            TriggerCTA: function () {
if ( TRACE ) { TRACE( "VideoManager#TriggerCTA", this ); }
            ...
            /*VideoManager.TriggerCTA end.*/

            /*VideoManager.Button start.*/
            Button: function () {
if ( TRACE ) { TRACE( "VideoManager#Button", this ); }

                var scale = this.image.transform.localScale.$clone();
                scale = this.image.transform.localScale.$clone().sub( new pc.Vec3( 0.1, 0.1, 0.1 ) );
                DG.Tweening.TweenSettingsExtensions.SetLoops$1(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale$1(this.image.transform, scale.$clone(), 0.5), DG.Tweening.Ease.Linear), -1, DG.Tweening.LoopType.Yoyo);
            },
            /*VideoManager.Button end.*/
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","System.Collections","UnityEngine","UnityEngine.Video","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening","DG.Tweening.Plugins.Core.PathCore","UnityEngine.UI","System.Globalization","DG.Tweening.Plugins.Options"];

    /*DeviceOrientation start.*/
    $m("DeviceOrientation", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"CheckOrientation","t":8,"sn":"CheckOrientation","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"isVertical","t":4,"rt":$n[0].Boolean,"sn":"isVertical","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":4,"n":"onLandscapeMode","is":true,"t":4,"rt":Function,"sn":"onLandscapeMode"},{"a":4,"n":"onPortraitMode","is":true,"t":4,"rt":Function,"sn":"onPortraitMode"}]}; }, $n);
    /*DeviceOrientation end.*/

    /*Hand start.*/
    $m("Hand", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Click","t":8,"sn":"Click","rt":$n[0].Void},{"a":1,"n":"Loop","t":8,"sn":"Loop","rt":$n[1].IEnumerator},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"anim","t":4,"rt":$n[2].Animator,"sn":"anim"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"point1","t":4,"rt":$n[2].Transform,"sn":"point1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"point2","t":4,"rt":$n[2].Transform,"sn":"point2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"source","t":4,"rt":$n[2].AudioSource,"sn":"source"}]}; }, $n);
    /*Hand end.*/

    /*VideoConverter start.*/
    $m("VideoConverter", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"DecodeBase64ToVideo","t":8,"pi":[{"n":"base64","pt":$n[0].String,"ps":0}],"sn":"DecodeBase64ToVideo","rt":$n[0].String,"p":[$n[0].String]},{"a":1,"n":"EncodeVideoToBase64","t":8,"pi":[{"n":"path","pt":$n[0].String,"ps":0}],"sn":"EncodeVideoToBase64","rt":$n[0].String,"p":[$n[0].String]},{"a":1,"n":"LoadVideo","t":8,"sn":"LoadVideo","rt":$n[1].IEnumerator},{"a":1,"n":"PlayVideo","t":8,"pi":[{"n":"path","pt":$n[0].String,"ps":0}],"sn":"PlayVideo","rt":$n[0].Void,"p":[$n[0].String]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"name","t":4,"rt":$n[0].String,"sn":"name$1"},{"a":2,"n":"videoPathOriginal","t":4,"rt":$n[0].String,"sn":"videoPathOriginal"},{"a":2,"n":"videoPlayer","t":4,"rt":$n[3].VideoPlayer,"sn":"videoPlayer"}]}; }, $n);
    /*VideoConverter end.*/

    /*VideoManager start.*/
    $m("VideoManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"Button","t":8,"sn":"Button","rt":$n[0].Void},{"a":1,"n":"OnHorizontal","t":8,"sn":"OnHorizontal","rt":$n[0].Void},{"a":1,"n":"OnVertical","t":8,"sn":"OnVertical","rt":$n[0].Void},{"a":2,"n":"TriggerCTA","t":8,"sn":"TriggerCTA","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"BG_V","t":4,"rt":$n[2].GameObject,"sn":"BG_V"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"ScreenHorizon","t":4,"rt":$n[2].GameObject,"sn":"ScreenHorizon"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"ScreenVertical","t":4,"rt":$n[2].GameObject,"sn":"ScreenVertical"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"audioBG","t":4,"rt":$n[2].AudioSource,"sn":"audioBG"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"canvasHorizon","t":4,"rt":$n[2].Canvas,"sn":"canvasHorizon"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"canvasVertical","t":4,"rt":$n[2].Canvas,"sn":"canvasVertical"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"fullVidHorizon","t":4,"rt":$n[3].VideoPlayer,"sn":"fullVidHorizon"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"fullVidVertical","t":4,"rt":$n[3].VideoPlayer,"sn":"fullVidVertical"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"hand","t":4,"rt":Hand,"sn":"hand"},{"a":1,"n":"highCanvas","t":4,"rt":$n[0].Int32,"sn":"highCanvas","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"image","t":4,"rt":$n[2].GameObject,"sn":"image"},{"a":1,"n":"isVertical","t":4,"rt":$n[0].Boolean,"sn":"isVertical","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"lowCanvas","t":4,"rt":$n[0].Int32,"sn":"lowCanvas","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*VideoManager end.*/
