...
{
	[SerializeField]
	private VideoPlayer fullVidHorizon;

	[SerializeField]
	private VideoPlayer fullVidVertical;

	[SerializeField]
	private GameObject ScreenHorizon;

	[SerializeField]
	private GameObject ScreenVertical;
	...
	[SerializeField]
	private GameObject BG_V;

	[SerializeField]
	private Canvas canvasHorizon;

	[SerializeField]
	private Canvas canvasVertical;
	...
	public void Button()
	{
		...
		image.transform.DOScale(scale, 0.5f).SetEase(Ease.Linear).SetLoops(-1, LoopType.Yoyo);
	}
}
